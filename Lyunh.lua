...
Logo.Image = "http://www.roblox.com/asset/?id=105486552530887" 
...
Title.Text = "Đăng Ký KhoitongDZ & Join Discord!"
...
PoweredBy.Text = "Script Powered By KhoitongDZ"
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "Click để tham gia Discord của tôi!",
    Callback = function()
        setclipboard("https://discord.gg/w26VGWmMPb")
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Đã sao chép link Discord!",
            Text = "Dán link vào trình duyệt để tham gia nhé!",
            Duration = 5
        })
    end
})
...
local ExecutorLevel = v16.Home:AddParagraph({
